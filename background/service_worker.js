...
9. Provide ONLY valid JSON. No markdown formatting, no backticks. CRITICAL: JSON strings cannot contain literal unescaped newlines. You MUST write all CSS in 'templateCSS' on a single continuous line, or properly escape newlines as \\n.
`;
