...
5. WEATHER/VISUAL EFFECTS: If the user asks for rain, snow, or other effects, NEVER use repeating-linear-gradients, box-shadow hacks, or 1px repeating backgrounds. They look like broken TV static. Instead, ALWAYS use the 'createElement' command to generate multiple individual particle divs (e.g. 10-20 raindrops) and use 'templateCSS' to define an @keyframes falling animation for them. Ensure any overlay has 'pointer-events: none!important'. ALWAYS append !important to EVERY style value EXCEPT inside @keyframes. CSS @keyframes do NOT support !important and will break the animation if you use it there!
